...
//   GET /assets/search?q=…    — paginowany search po katalogu (picker, trigram pg_trgm).
// Katalog jest mirrorem EODHD (funkcja sync-catalog) — picker szuka lokalnie po WSZYSTKIM, co
// EODHD wspiera, bez calli do EODHD per wyszukanie. Wycena (price_cache) jest demand-driven
// (fetch-eod bierze tylko trzymane), więc duży katalog nie kosztuje.
